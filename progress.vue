      ...
      <div class="hero-body">
        <div class="container">
          ...
          <div v-if="showInfo" class="notification is-warning">
            ...
            <p>
              At a rate of {{ estimate.diff.toLocaleString() }} lines of
              assembly decompiled every {{ estimate.daysPassed }} days, it will
              take {{ estimate.timeBetweenString }} to decompile the remaining
              {{ remaining }} lines.
            </p>

            Learn
            <router-link to="faq/#how-to-contribute"
            ...
            <p>
              <i>
                * This estimation is calculated automatically based on the rate
                of contributions in the previous {{ threshold }} days.
              </i>
            </p>
          </div>
          <progress class="progress is-success" :value="percent" max="100">
            45%
          </progress>
        </div>
      </div>
...
import { getEstimate, dayThreshold } from "./estimate.js";
...
export default {
  ...
  data() {
    return {
      showInfo: false,
      percent:
        Math.round((Info.stats.linesDone / Info.stats.linesTotal) * 10000) /
        100,
      estimate: est,
